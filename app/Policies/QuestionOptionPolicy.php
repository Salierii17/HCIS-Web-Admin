...
class QuestionOptionPolicy
{
     ...
     */
    public function view(App\Models\User $user, QuestionOption $questionoption): bool
    {
     ...
     */
    public function update(App\Models\User $user, QuestionOption $questionoption): bool
    {
     ...
     */
    public function delete(App\Models\User $user, QuestionOption $questionoption): bool
    {
     ...
     */
    public function restore(App\Models\User $user, QuestionOption $questionoption): bool
    {
     ...
     */
    public function replicate(App\Models\User $user, QuestionOption $questionoption): bool
    {
     ...
     */
    public function forceDelete(App\Models\User $user, QuestionOption $questionoption): bool
    {
