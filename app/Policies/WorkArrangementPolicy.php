...
class WorkArrangementPolicy
{
     ...
     */
    public function view(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
     ...
     */
    public function update(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
     ...
     */
    public function delete(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
     ...
     */
    public function restore(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
     ...
     */
    public function replicate(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
     ...
     */
    public function forceDelete(App\Models\User $user, WorkArrangement $workarrangement): bool
    {
