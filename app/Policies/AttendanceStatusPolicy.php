...
class AttendanceStatusPolicy
{
     ...
     */
    public function view(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
     ...
     */
    public function update(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
     ...
     */
    public function delete(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
     ...
     */
    public function restore(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
     ...
     */
    public function replicate(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
     ...
     */
    public function forceDelete(App\Models\User $user, AttendanceStatus $attendancestatus): bool
    {
