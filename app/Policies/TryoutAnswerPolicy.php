...
class TryoutAnswerPolicy
{
     ...
     */
    public function view(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
     ...
     */
    public function update(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
     ...
     */
    public function delete(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
     ...
     */
    public function restore(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
     ...
     */
    public function replicate(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
     ...
     */
    public function forceDelete(App\Models\User $user, TryoutAnswer $tryoutanswer): bool
    {
