...
use App\Filament\Resources\AttendanceApprovalResource\RelationManagers;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('employee_reason')
                    ->label('Reason')
                    ->limit(40)
                    ->tooltip(fn (AttendanceCorrectionRequest $record): string => $record->employee_reason),
            ])
            ->filters([
                //
            ])
            ->actions([
                ...
                ->action(function (AttendanceCorrectionRequest $record) {
